...
configPkg/linker.cmd: build-1101710319 ../hello.cfg
configPkg/compiler.opt: build-1101710319
configPkg/: build-1101710319

build-1610717377:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1610717377-inproc

build-1610717377-inproc: ../hello.syscfg
	@echo 'Building file: "$<"'
...
syscfg/ti_drivers_config.c: build-1610717377 ../hello.syscfg
syscfg/ti_drivers_config.h: build-1610717377
syscfg/syscfg_c.rov.xs: build-1610717377
syscfg/: build-1610717377
